...
replacement-site scenario and save it as the importer's test fixture:
    ...
    → lib/intake/__fixtures__/intake-sample-2.9.0.xlsx
...
SRC = os.path.join(ROOT, "templates", "source", "EVSE_Project_Intake_TEMPLATE_2.9.0.xlsx")
OUT = os.path.join(ROOT, "lib", "intake", "__fixtures__", "intake-sample-2.9.0.xlsx")
