...
replacement-site scenario and save it as the importer's test fixture:
    ...
    → lib/intake/__fixtures__/intake-sample-3.8.1.xlsx
...
SRC = os.path.join(ROOT, "templates", "source", "EVSE_Project_Intake_TEMPLATE_3.8.1.xlsx")
OUT = os.path.join(ROOT, "lib", "intake", "__fixtures__", "intake-sample-3.8.1.xlsx")
...
# Section I (3.7.2) — capacity of the existing service: a 320 kW measured peak (NEC 220.87), a spare position, utility told.
