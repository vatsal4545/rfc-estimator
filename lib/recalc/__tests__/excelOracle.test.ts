...
describe("the engine reproduces what Excel computed", () => {
  ...
  it("evaluates the whole intake template, which ships with nothing cached", async () => {
    ...
    // short (Electrical!N160, B211–B214, C211–C213, Construction!B66), and so
    // was 3.7.0. The app's copies carried the CEO's own corrected text for
    // those nine cells until 3.7.2, whose published file is clean — this
    // template copy is his file, byte for byte.
