...
export const HARDWARE_ALLOWANCE: Record<string, number> = {
  ...
  "DCFC 60kW": 28500,
  "DCFC 60kW Dual": 31350,
  "DCFC 100kW": 45500,
  "DCFC 100kW Dual": 45500,
  "DCFC 120kW": 54000,
  "DCFC 120kW Dual": 59400,
  "DCFC 160kW": 57000,
  "DCFC 160kW Dual": 68200,
  "DCFC 180kW": 62000,
  "DCFC 180kW Dual": 62000,
  "DCFC 200kW": 68000,
  "DCFC 200kW Dual": 68000,
  "DCFC 240kW": 80000,
  "DCFC 240kW Dual": 88000,
  "DCFC 275kW": 85500,
...
export const HARDWARE_ALLOWANCE_BASIS: Record<string, string> = {
  ...
  "DCFC 60kW Dual": "CTX-AiO-60-x-200 list — the dual-cable AiO, not the TP5 single",
  ...
  "DCFC 120kW Dual": "CTX-AiO-120-x-350 list — the model IS the CTX Gen3 AiO its notes name",
  "DCFC 160kW": "TP5-160-480-x list",
  "DCFC 160kW Dual": "CTX-AiO-160-x-350 list — the model IS the CTX Gen3 AiO its notes name",
  ...
  "DCFC 240kW": "TP5-240-480-x-300 list",
  "DCFC 240kW Dual": "CTX-AiO-240-x-300 list — the model IS the CTX Gen3 AiO its notes name",
