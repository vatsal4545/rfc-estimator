...
export const DEFAULT_LOAD_TYPES: LoadType[] = [
  ...
  { id: "DCFC 60kW Dual", category: "DCFC", voltage: 480, phases: 3, kwPerPort: 60, runsPerUnit: 1, conductorsPerRun: 3, feederOcpdA: 100, designMinCu: "1/0 AWG", designMinAl: "1 AWG", hasDataCable: true, runsAreParallel: false, portsPerUnit: 2, notes: "Dual-cable AiO (CTX Gen3 60kW): one unit, one circuit, two billable ports sharing 60kW" },
