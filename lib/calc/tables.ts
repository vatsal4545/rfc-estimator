...
export const WIRE_TABLE: WireRow[] = [
  ...
  { size: "450 kcmil", circularMils: 450000, ampacityCu: 355, ampacityAl: 290, cuPerFt: 11.334, alPerFt: 0, conduitTradeSize: '3"', note: "450 kcmil is NOT in NEC 310.16 - ampacity interpolated, verify" },
...
export const DEFAULT_LOAD_TYPES: LoadType[] = [
  ...
  { id: "L2 Dual 80A", category: "L2", voltage: 208, phases: 1, kwPerPort: 8.32, runsPerUnit: 2, conductorsPerRun: 2, feederOcpdA: 50, unitInputAmps: 80, designMinCu: "8 AWG", designMinAl: "6 AWG", hasDataCable: true, runsAreParallel: false, notes: "80A dual-port unit: two 40A ports, each its own 2-pole 50A circuit (40A x 125%)" },
